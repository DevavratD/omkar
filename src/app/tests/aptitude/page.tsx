...
export default function AptitudeSelection() {
  const tests = [
    { 
      id: '2-4', 
      name: 'Classes 2–4', 
      desc: 'Early cognitive development and foundational logic.', 
    ...
    { 
      id: '5-7', 
      name: 'Classes 5–7', 
      desc: 'Developing analytical and numerical reasoning.', 
    ...
    { 
      id: '8-10', 
      name: 'Classes 8–10', 
      desc: 'Foundational cognitive assessment.', 
      icon: <Compass className="w-10 h-10 text-emerald-600" />,
      glowColor: 'bg-emerald-500/10 text-emerald-600'
    },
    { 
      id: '11-12', 
      name: 'Classes 11–12', 
      desc: 'Advanced reasoning and cognitive pattern recognition.', 
    ...
    { 
      id: 'professional', 
      name: 'Professionals', 
      desc: 'High-level analytical and cognitive evaluation.', 
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-slate-800 font-sans selection:bg-emerald-100/50 pt-12 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-xl text-slate-500 text-center mb-16 font-medium">
          Select the appropriate grade level to begin the cognitive test.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {tests.map(test => (
            <Link 
              key={test.id} 
              href={`/tests/aptitude/${test.id}`}
              className="group flex flex-col items-start p-10 bg-white/80 backdrop-blur-xl border border-white/60 rounded-[2.5rem] shadow-xl shadow-slate-200/50 hover:shadow-2xl hover:shadow-emerald-500/10 hover:-translate-y-2 transition-all duration-500 relative overflow-hidden"
            >
              ...
              <h3 className="text-3xl font-black text-slate-900 mb-4 tracking-tight relative z-10 group-hover:text-emerald-700 transition-colors duration-300">
                {test.name}
              </h3>
